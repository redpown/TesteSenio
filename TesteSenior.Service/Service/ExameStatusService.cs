...
{
    public class ExameStatusService : ExameStatusRepository
    {

        public ExameStatusService(TesteSeniorConext testeSeniorConext, IMapper mapper) : base(testeSeniorConext, mapper)
        {
        }
        /*
