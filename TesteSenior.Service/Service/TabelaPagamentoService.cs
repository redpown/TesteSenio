...
{
    public class TabelaPagamentoService : TabelaPagamentosCondominioRepository
    {
        public TabelaPagamentoService(TesteSeniorConext testeSeniorConext, IMapper mapper) : base(testeSeniorConext, mapper)
        {
        }
