...
{
    public class TabelaEdificioService : TabelaEdificioRepository
    {
        public TabelaEdificioService(TesteSeniorConext testeSeniorConext, IMapper mapper) : base(testeSeniorConext, mapper)
        {
        }
