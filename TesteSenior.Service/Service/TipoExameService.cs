...
{
    public class TipoExameService : TipoExameRepository
    {

        public TipoExameService(TesteSeniorConext testeSeniorConext, IMapper mapper) : base(testeSeniorConext, mapper)
        {
        }
        /*
